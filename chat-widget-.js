// Chat Widget Script (beige background + larger/thicker message font + bigger icon + no footer)
(function() {
    ...
    const styles = `
        .n8n-chat-widget {
            ...
            --chat--color-background: var(--n8n-chat-background-color, #fffaf5); /* CHANGED from #ffffff */
        ...
        .n8n-chat-widget .brand-header img { width: 32px; height: 32px; object-fit: contain; }
        ...
        .n8n-chat-widget .chat-toggle svg { width: 40px; height: 40px; fill: currentColor; } /* CHANGED from 24px */
